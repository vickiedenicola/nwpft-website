...
(function () {
  ...
  function mailA() {
    return '<a href="contact.html" aria-label="Email us" title="Email us">' +
      '<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="' + ICONS.email + '"/></svg>' +
    '</a>';
  }
